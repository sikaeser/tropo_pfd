...
'''
Script to calculate the potential energy, forces and dipole of a structure.
...
#setup calculator
calc = NNCalculator(
    checkpoint="models_tropo_tlcc/tropo_ccsdt_TLSET3_100struct_seed150", #load the model you want to used
    atoms=atoms,
    charge=args.charge,
    F=128,
    K=64,
